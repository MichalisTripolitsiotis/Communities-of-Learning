...
$start_from = ($page-1) * $limit;  
			...
			$sql=mysqli_query($con,"SELECT * FROM texts WHERE tag='C.S.U.' ORDER BY date DESC LIMIT $start_from, $limit");
			while($row2 = mysqli_fetch_assoc($sql)){
          ...
          <?php }?>
             ...
             <?php  
$sql2 = "SELECT COUNT(id) FROM texts WHERE tag='C.S.U.'";  
...
for ($i=1; $i<=$total_pages; $i++) {  
             $pagLink .= "<a href='csu.php?page=" .$i."'>" .$i. "</a>";  
};  
echo $pagLink . "</div>";  
?>
...
<?php elseif ($var_role == 'staff' AND $var_upload=='C.S.U.' ): ?>
<div class="content3">
<div class="container">
  <div class="row">
  <!-------------------------- NavBar ----------------------------------------------------------------------------->
