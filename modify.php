...
if(isset($_POST['modify'])){
		...
		$var_id=$_POST['txtId'];
 $sql = "SELECT * FROM texts WHERE id =" .$var_id;
 $result = mysqli_query($con, $sql);
...
<div class="container">
      ...
      <a class="nav-link" id="v-pills-home-tab" href="admin.php" role="tab" aria-controls="v-pills-home" aria-selected="true"><i class="fa fa-home fa-fw" aria-hidden="true"></i>&nbsp;Home</a>
       ...
       <a class="nav-link" data-toggle="collapse" data-target="#expand" style="cursor:pointer;" role="tab" aria-controls="v-pills-messages" aria-selected="false"><i class="fa fa-bullseye" aria-hidden="true"></i>&nbsp;Activities</a>
            ...
            <li class="list-group-item " ><a href="sportsclub.php" <i class="fas fa-futbol"></i>&nbsp;Sports Club</a></li>
                <li class="list-group-item " ><a href="bookclub.php" <i class="fas fa-book-open"></i>&nbsp;Book Club</a></li>
                <li class="list-group-item"><a href="marketingclub.php" <i class="fas fa-marker"></i>&nbsp;Marketing Club</a></li>
                 <li class="list-group-item"><a href="financeclub.php" <i class="fas fa-chart-bar"></i>&nbsp;Finance Club</a></li>
                 <li class="list-group-item"><a href="sunriseclub.php" <i class="fas fa-people-carry"></i>&nbsp;SUNRISE Movement for Social Responsibility</a></li>
                <li class="list-group-item"><a href="roboticsclub.php" <i class="fas fa-robot"></i>&nbsp;Robotics Club</a></li>
                <li class="list-group-item"><a href="researchclub.php" <i class="fas fa-swatchbook"></i>&nbsp;Research Club</a></li>
                <li class="list-group-item"><a href="musicclub.php" <i class="fas fa-music"></i>&nbsp;Music Club</a></li>
                 <li class="list-group-item"><a href="danceclub.php" <i class="fas fa-drum"></i>&nbsp;Dance Club</a></li>
                  <li class="list-group-item"><a href="gogreenclub.php" <i class="fas fa-leaf"></i>&nbsp;Go Green Club</a></li>
                   <li class="list-group-item"><a href="infinityclub.php" <i class="fas fa-infinity"></i>&nbsp;INFINITY Club</a></li>
                    <li class="list-group-item"><a href="boardgamesclub.php" <i class="fab fa-fort-awesome"></i>&nbsp;Strategic Board Games Club</a></li>
                    <li class="list-group-item"><a href="avclub.php" <i class="fas fa-video"></i>&nbsp;A/V Club</a></li>
                <li class="list-group-item"><a href="csuclub.php"<i class="fas fa-users" aria-hidden="true"></i>&nbsp;C.S.U.</a></li>
                <br>
            </ul>
        </div> 
 ...
 ?>
		<form action="modifytext.php" method="post">
