...
<head>
<meta charset="utf-8">
<title>Professional Seminars</title>
...
$start_from = ($page-1) * $limit;  
			...
			$sql=mysqli_query($con,"SELECT * FROM texts WHERE tag='Professional Seminars' ORDER BY date DESC LIMIT $start_from, $limit");
			while($row2 = mysqli_fetch_assoc($sql)){
          ...
          <?php }?>
             ...
             <?php  
$sql2 = "SELECT COUNT(id) FROM texts WHERE tag='Professional Seminars'";  
...
for ($i=1; $i<=$total_pages; $i++) {  
             $pagLink .= "<a href='professionalseminars.php?page=" .$i."'>" .$i. "</a>";  
};  
echo $pagLink . "</div>";  
?>
...
<?php elseif ($var_role == 'staff' AND $var_upload=='Professional Seminars' ): ?>
<div class="content3">
<div class="container">
  <div class="row">
  <!-------------------------- NavBar ----------------------------------------------------------------------------->
...
$start_from = ($page-1) * $limit;  
			...
			$sql=mysqli_query($con,"SELECT * FROM texts WHERE tag='Professional Seminars' AND Department='Computer Science' ORDER BY date DESC LIMIT $start_from, $limit");	
			while($row2 = mysqli_fetch_assoc($sql)){	
			$query = mysqli_query($con, "SELECT * FROM diss.staff WHERE id =".$row2['user_fk']);
          ...
          <?php }?>
              ...
              <?php  
$sql2 = "SELECT COUNT(id) FROM texts WHERE tag='Professional Seminars' AND Department='Computer Science'";  
$rs_result = mysqli_query($con,$sql2);  
$row = mysqli_fetch_row($rs_result);  
$total_records = $row[0];  
$total_pages = ceil($total_records / $limit);  
...
$start_from = ($page-1) * $limit;  
			...
			$sql=mysqli_query($con,"SELECT * FROM texts WHERE tag='Professional Seminars' AND Department='Business Administration & Economics' ORDER BY date DESC LIMIT $start_from, $limit");	
			while($row2 = mysqli_fetch_assoc($sql)){	
			$query = mysqli_query($con, "SELECT * FROM diss.staff WHERE id =".$row2['user_fk']);
          ...
          <?php }?>
              ...
              <?php  
$sql2 = "SELECT COUNT(id) FROM texts WHERE tag='Professional Seminars' AND Department='Business Administration & Economics'";  
$rs_result = mysqli_query($con,$sql2);  
$row = mysqli_fetch_row($rs_result);  
$total_records = $row[0];  
$total_pages = ceil($total_records / $limit);  
...
$start_from = ($page-1) * $limit;  
			...
			$sql=mysqli_query($con,"SELECT * FROM texts WHERE tag='Professional Seminars' AND Department='English Studies' ORDER BY date DESC LIMIT $start_from, $limit");	
			while($row2 = mysqli_fetch_assoc($sql)){	
			$query = mysqli_query($con, "SELECT * FROM diss.staff WHERE id =".$row2['user_fk']);
          ...
          <?php }?>
              ...
              <?php  
$sql2 = "SELECT COUNT(id) FROM texts WHERE tag='Professional Seminars' AND Department='English Studies'";  
$rs_result = mysqli_query($con,$sql2);  
$row = mysqli_fetch_row($rs_result);  
$total_records = $row[0];  
$total_pages = ceil($total_records / $limit);  
...
$start_from = ($page-1) * $limit;  
			...
			$sql=mysqli_query($con,"SELECT * FROM texts WHERE tag='Professional Seminars' AND Department='Psychology Department' ORDER BY date DESC LIMIT $start_from, $limit");	
			while($row2 = mysqli_fetch_assoc($sql)){	
			$query = mysqli_query($con, "SELECT * FROM diss.staff WHERE id =".$row2['user_fk']);
          ...
          <?php }?>
              ...
              <?php  
$sql2 = "SELECT COUNT(id) FROM texts WHERE tag='Professional Seminars' AND Department='Psychology Department'";  
$rs_result = mysqli_query($con,$sql2);  
$row = mysqli_fetch_row($rs_result);  
$total_records = $row[0];  
$total_pages = ceil($total_records / $limit);  
