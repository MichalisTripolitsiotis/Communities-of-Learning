...
$start_from = ($page-1) * $limit;  
			...
			$sql=mysqli_query($con,"SELECT * FROM texts WHERE tag='Carreer Day' ORDER BY date DESC LIMIT $start_from, $limit");
			while($row2 = mysqli_fetch_assoc($sql)){
          ...
          <?php }?>
             ...
             <?php  
$sql2 = "SELECT COUNT(id) FROM texts WHERE tag='Carreer Day'";  
...
for ($i=1; $i<=$total_pages; $i++) {  
             $pagLink .= "<a href='carreerday.php?page=" .$i."'>" .$i. "</a>";  
};  
echo $pagLink . "</div>";  
?>
...
<?php elseif ($var_role == 'staff' AND $var_upload=='Carreer Day' ): ?>
<div class="content3">
<div class="container">
  <div class="row">
  <!-------------------------- NavBar ----------------------------------------------------------------------------->
